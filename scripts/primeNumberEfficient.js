...
const isPrime = (n) => {
  ...
  for (var i = 5; i <= Math.sqrt(n); i = i + 6) {
    if (n % i == 0 || n % (i + 2) == 0)
      return `Ooops! ${n} is not a prime number.`;
  }
      
  return `Yay! ${n} is a prime number.`;
};
